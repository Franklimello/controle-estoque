...
const ExitsHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-0 md:p-6">
           {" "}
      {/* Garante que o container se ajuste a 100% da largura em mobile */}     {" "}
      <div className="max-w-full lg:max-w-7xl mx-auto px-4 md:px-0">
        ...
               {" "}
        {/* FILTROS RESPONSIVOS - Garantido em coluna única no mobile (grid-cols-1) */}
               {" "}
        ...
        <div className="hidden md:block bg-white shadow rounded-lg mb-4">
                   {" "}
          {/* OBLIGATÓRIO: Força a rolagem horizontal somente na tabela, não na página */}
                   {" "}
              ...
              <tbody className="divide-y">
                ...
                {filteredExits.length > 0 ? (
                  ...
                  <tr>
                    ...
                    >
                                            Nenhuma saída encontrada com os
                      filtros atuais.                    {" "}
                    </td>
                                     {" "}
                  </tr>
